...
acq_df = pd.read_pickle(os.path.join(const.DATA_PATH, '20171008_SDC_bank_merger_state.xlsx'))
...
merged_df['acq_state_acquiring_tar_state_dummy'] = merged_df['acq_state_acquiring_tar_state_dummy'].fillna(0)
