...
# @Filename: step02_merge_county_data_to_previous_dataset
# @Date: 18/10/2018
# @Author: Mark Wang
# @Email: wangyouan@gamil.com

"""
python3 -m generate_vars_20181018.step02_merge_county_data_to_previous_dataset
"""
...
SOD_DATA2_PATH = os.path.join(const.DATA_PATH, '20180908_revision', 'Branch Office Deposits')
...
if __name__ == '__main__':
    ...
    # data_df_append_tar_fips = data_df.merge(bhcf_data_df, on=[const.YEAR, TAR_9001], how='left')
