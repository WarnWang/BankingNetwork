...
if __name__ == '__main__':
    psm_result = pd.read_pickle(os.path.join(const.TEMP_PATH, '20170831_CAR_real_fault_file.pkl'))
    ...
    merged_psm_data_df.to_pickle(os.path.join(const.TEMP_PATH, '20170903_merged_psm_data_file.pkl'))
    merged_psm_data_df.to_csv(os.path.join(const.RESULT_PATH, '20170903_merged_psm_data_file.csv'), index=False,
